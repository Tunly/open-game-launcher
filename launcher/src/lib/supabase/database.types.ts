  ...
  public: {
    Tables: {
      ...
      user_cloud_save_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_cloud_save_files_owner_fk"
            columns: ["save_set_id", "user_id"]
            isOneToOne: false
            referencedRelation: "user_cloud_save_sets"
            referencedColumns: ["id", "user_id"]
          },
          {
            foreignKeyName: "user_cloud_save_files_save_set_id_fkey"
            columns: ["save_set_id"]
            isOneToOne: false
            referencedRelation: "user_cloud_save_sets"
            referencedColumns: ["id"]
