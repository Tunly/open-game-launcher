...
export function FpsHudPage() {
  ...
  if (!metrics) {
    return (
      <div className="flex h-full items-center justify-center text-[10px] font-black uppercase text-[#655f58] neo-copy">
        •••
      </div>
    );
  }
  ...
  return (
    <div className="flex h-full items-center gap-2 border-[3px] border-[#171411] bg-[#fbf8ef] px-2 py-1 text-[11px] font-black uppercase neo-copy shadow-[3px_3px_0_#1f1c0f]">
