    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2 border-b-2 border-black pb-2">
        <div className="min-w-0">
          ...
          <h3 className="mt-1 text-sm font-black uppercase text-[#171411]">Provider Caps Proof</h3>
        </div>
      ...
      <div className="mt-2 grid gap-1">
        {proof.guards.map((guard) => (
          <p
            className="neo-copy border-2 border-black bg-[#f3e8d7] px-2 py-1 text-[8px] font-black uppercase leading-4 text-[#171411]"
            key={guard}
          >
            {guard}
          </p>
    ...
    <article className="border-2 border-black bg-[#efe3cf] p-2 shadow-[1px_1px_0_#171411]">
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className="neo-copy break-words text-[8px] font-black uppercase leading-4 text-[#5b403f]">
...
function ProviderCapsCheckLine({ check }: { check: ProviderArtworkCapsCheck }) {
  return (
    <div className="grid gap-1 border-2 border-black bg-[#fff9ed] px-2 py-1 text-[8px] font-black uppercase leading-4 text-[#171411]">
