      ...
      <div className="space-y-3 p-3">
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0">
                  <span className="neo-copy block text-[8px] font-black uppercase text-[#b7102a]">
                    {item.moderationStatus} / {item.reportCount} Reports
                  </span>
                  <span className="block truncate text-[10px] font-black uppercase text-[#171411]">
                    {item.title}
                  </span>
                  <span className="neo-copy block truncate text-[8px] font-black uppercase text-[#655f58]">
        ...
        {selectedItem ? (
          <div className="border-2 border-black bg-[#fff9ed] p-2 shadow-[2px_2px_0_#171411]">
            <p className="neo-copy text-[8px] font-black uppercase text-[#5b403f]">Review Packet</p>
            <h3 className="mt-1 text-[13px] font-black uppercase leading-none text-[#171411]">
              {selectedItem.title}
            </h3>
            <p className="neo-copy mt-2 text-[8px] font-black uppercase leading-4 text-[#655f58]">
            ...
            <div className="mt-2 grid grid-cols-3 gap-1">
              <button
                className="inline-flex h-8 items-center justify-center gap-1 border-2 border-black bg-[#087d6d] px-1 text-[8px] font-black uppercase text-white shadow-[1px_1px_0_#171411]"
                type="button"
              ...
              <button
                className="inline-flex h-8 items-center justify-center gap-1 border-2 border-black bg-[#efe3cf] px-1 text-[8px] font-black uppercase text-[#171411] shadow-[1px_1px_0_#171411]"
                type="button"
              ...
              <button
                className="inline-flex h-8 items-center justify-center gap-1 border-2 border-black bg-[#b7102a] px-1 text-[8px] font-black uppercase text-white shadow-[1px_1px_0_#171411]"
                type="button"
        ...
        >
          ...
          <div className="mt-2 grid gap-1.5">
            {consoleState.auditEntries.slice(0, 5).map((entry) => (
              <article
                className="border-2 border-[#fbf4e7] bg-[#2a221b] px-2 py-1 text-[8px] font-black uppercase leading-4"
                key={entry.id}
              >
