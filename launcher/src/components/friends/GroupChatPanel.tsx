...
export function GroupChatPanel({ currentUserId, friendIds, profilesById = {} }: GroupChatPanelProps) {
            ...
            {friendIds.map((id) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span className="neo-copy text-[10px] font-bold text-[#171411] truncate">
