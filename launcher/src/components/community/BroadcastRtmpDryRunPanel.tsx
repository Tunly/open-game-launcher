    ...
    >
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-[280px_minmax(0,1fr)_280px]">
        <div className="border-2 border-black bg-[#efe3cf] p-3 shadow-[3px_3px_0_#171411]">
          <p className="neo-copy text-[10px] font-black text-[#5f574d] uppercase">Packet ID</p>
          <p className="neo-copy mt-2 border-2 border-black bg-[#fff9ed] px-2 py-1 text-[9px] leading-5 font-black break-words text-[#171411] uppercase">
            {packet.packetId}
          </p>
