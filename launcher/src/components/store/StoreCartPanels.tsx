...
export function CartDrawer({
  ...
  return (
    <ModalDialog
      backdropClassName="fixed inset-0 z-40 flex justify-end bg-[#171411]/80 bg-[radial-gradient(circle,rgba(255,249,237,0.12)_1px,transparent_1px)] bg-[length:10px_10px] p-3 sm:p-6"
      labelledBy="cart-drawer-title"
      panelClassName="flex max-h-[calc(100vh-1.5rem)] w-full max-w-md flex-col border-4 border-black bg-[#fff9ed] shadow-[8px_8px_0_#171411] sm:max-h-[calc(100vh-3rem)]"
      onDismiss={onClose}
    >
      <div className="flex items-center justify-between border-b-4 border-black bg-[#171411] px-4 py-3">
        <div>
          ...
          <h2 id="cart-drawer-title" className="neo-title text-3xl leading-none text-[#fff9ed]">
            Checkout Tape
          </h2>
        </div>
        <button
