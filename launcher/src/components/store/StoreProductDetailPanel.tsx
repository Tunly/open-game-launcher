...
export function ProductDetailPanel({
  ...
  return (
    <section className="grid overflow-hidden border-4 border-black bg-[#fff9ed] shadow-[6px_6px_0_#171411] lg:grid-cols-[minmax(0,1fr)_360px]">
      <div className="relative min-h-72 overflow-hidden border-b-4 border-black bg-[repeating-linear-gradient(112deg,#171411_0_14px,#302c25_14px_28px,#b7102a_28px_32px,#007166_32px_36px)] p-5 lg:border-b-0 lg:border-r-4">
        {game.coverImageUrl ? (
          <img
            alt=""
