...
export function StoreGameCard({
  ...
  return (
    <article className="overflow-hidden border-4 border-black bg-[#f5eedf] shadow-[5px_5px_0_#171411]">
      ...
      <div className="p-4">
        <h3 className="text-[1.35rem] font-black uppercase leading-none text-[#171411] sm:text-[1.5rem]">
          {game.title}
        </h3>
        ...
        <div className="flex items-end justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`flex h-10 w-10 items-center justify-center border-2 border-black shadow-[3px_3px_0_#171411] ${
                priceAlert ? "bg-[#8cf5e4] text-[#171411]" : "bg-[#fff9ed] text-[#171411]"
              }`}
              type="button"
              onClick={() => {
                if (priceAlert) {
        ...
        {priceAlert !== null ? (
          <p className="neo-copy mt-3 border-2 border-black bg-[#8cf5e4] p-2 text-[9px] font-black uppercase tracking-[0.1em] text-[#171411]">
            Alert below{" "}
            {new Intl.NumberFormat("en-US", {
              currency: "EUR",
              style: "currency",
