...
export function createLauncherUpdateStore(
  adapter: LauncherUpdateAdapter,
  now: () => Date = () => new Date(),
) {
  ...
  const useLauncherUpdateStore = create<LauncherUpdateState>()(() => initialState);
  ...
  function checkForLauncherUpdate(): Promise<LauncherUpdateState> {
  ...
  function installLauncherUpdate(): Promise<LauncherUpdateState> {
    if (installInFlight) return installInFlight;
    if (checkInFlight) return checkInFlight;
...
export const launcherUpdateStore = createLauncherUpdateStore(tauriLauncherUpdateAdapter);

export const useLauncherUpdateStore = launcherUpdateStore.useLauncherUpdateStore;
export const checkForLauncherUpdate = launcherUpdateStore.checkForLauncherUpdate;
export const installLauncherUpdate = launcherUpdateStore.installLauncherUpdate;
