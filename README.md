...
| `/community`                  | Community activity board + browser-local post composer + local broadcasting readiness                                           |
| `/news`                       | News feed                                                                                                                        |
...
- Public Screenshot Feed was removed from `/community`; `/community?verify=public-screenshot-feed` intentionally renders no screenshot-feed panel, and current community coverage lives in the activity board, local Create Post composer, and broadcasting readiness gates.
