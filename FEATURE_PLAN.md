...
## Auditierter Produktstand (2026-07-16)
...
| Game Actions und Client Automation                          | Capability-Vertrag lokal; Live-Evidenz offen                | Ausgewählte Kopien erhalten explizite Support/Verify/Repair/Update/Uninstall/Remove/Open-Provider-Fähigkeiten, native Ziel-Revalidierung und aktionsgebundene Bestätigung. Die semantische Windows-UI-Automation ist im Standard-Build aktiv und bleibt bei unbekannten oder mehrdeutigen Clientstrukturen fail-closed; reale Client-/OS-/Locale-Kompatibilität bleibt externe Evidenz.                                                                                       |
| Client Manager, Presence, Backup, Mods, Artwork und Invites | Lokale Implementierung/Staging vorhanden                    | Sichere lokale Pfade sind implementiert. Nexus Mods funktioniert ohne App-Slug per offizieller Website-Suchübergabe; registrierte SSO-Karten und native Installation sind nur eine optionale Erweiterung. Steam Workshop nutzt Client-Handoff/read-only Erkennung; mod.io, CurseForge, URL-/Archiv-/Ordnerimport und Provider-Key-UI sind kein aktiver Produktpfad. Normales Custom Artwork ist ausschließlich lokal pro ausgewählter Kopie. Provider-approved Apply/Mount, Hosted Cron, Cross-OS-Drive-E2E und Hosted-Invite-E2E bleiben offen. |
...
- **Mods:** Der normale No-Slug-Nexus-Website-Handoff ist releasefähig; nur die
  optionale registrierte SSO-/Download-/NXM-Erweiterung benötigt noch einen
  Live-Nachweis mit echtem Konto. Steam-Abos bleiben bis zur erforderlichen
  Valve-Freigabe Steam-verwaltet.
...
- **Cross-Play:** realer IGDB-Import und gehostete Zuordnungsevidenz.
...
| `provider-live-integrations` | reale Provider-, Library-, Achievement- und Presence-Nachweise einschließlich Nexus-/Steam-Handoff |
