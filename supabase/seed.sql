...
values
  (
    'foundry_dark',
    'Foundry Dark',
    'Industrial dark room theme with warm monitor glow.',
    'gradient',
    'linear-gradient(135deg,#080b12,#151923 48%,#2a1418)',
    '#38bdf8',
    '#f8fafc',
    'glass',
    false,
  ...
  (
    'neon_den',
    'Neon Den',
    'Arcade-inspired profile room with teal and magenta accents.',
    'gradient',
    'radial-gradient(circle at 20% 20%,rgba(20,184,166,.28),transparent 32%),linear-gradient(135deg,#07080d,#1f1023)',
    '#14b8a6',
    '#f8fafc',
    'neon',
    false,
